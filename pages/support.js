  ...
  return (
    <Container>
      ...
      <Section fullWidth color='gray'>
        ...
        <Grid rows='grid2'>
          <Describe imgOn radiusOn img='/card_03.JPG'></Describe>
          <Describe radiusOn>
            <div>
              自分らしく学べる場所
              <br />
        ...
        <Grid rows='grid2'>
          <Describe imgOn radiusOn img='/card_08.JPG'></Describe>
          <Describe radiusOn>
            <div>
              フリースクール概要
              <br />
        ...
        <Button link='https://unippo.peatix.com/' rightOn altColor>
          フリースクールに参加する
        </Button>
      </Section>
